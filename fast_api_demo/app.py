...
description = """
fast_api_demo API helps you do awesome stuff. 🚀
"""
...
app = FastAPI(
    ...
    terms_of_service="http://fast_api_demo.com/terms/",
    contact={
        "name": "2150997113",
        "url": "http://fast_api_demo.com/contact/",
        "email": "2150997113@fast_api_demo.com",
    },
    license_info={
        "name": "The Unlicense",
