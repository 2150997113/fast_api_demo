...
# WARNING: Ensure imports from `fast_api_demo` comes after this line
from fast_api_demo import app, settings, db  # noqa
from fast_api_demo.cli import create_user, cli  # noqa
